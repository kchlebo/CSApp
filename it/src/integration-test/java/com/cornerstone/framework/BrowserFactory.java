...
public class BrowserFactory {
	 ...
	 * Singleton pattern
	 * Only one instance of a browser type
	 */
	...
	private static InternetExplorerOptions InitializeIEContext()
    {
        ...
        System.setProperty("webdriver.ie.driver", "src/integration-test/selenium/IEDriverServer.exe");
	...
	private static void getChromeBrowser(WebDriver driver)
	{
		...
		System.setProperty("webdriver.chrome.driver","src/integration-test/selenium/ChromeDriver.exe");
